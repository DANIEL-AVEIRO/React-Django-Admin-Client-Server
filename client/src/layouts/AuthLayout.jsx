...
const AuthLayout = () => {
  return (
    <main className="relative flex min-h-screen items-center justify-center overflow-hidden bg-slate-100 px-4 py-10 sm:px-6">
      ...
      <div className="relative grid w-full max-w-5xl overflow-hidden rounded-4xl bg-white shadow-2xl shadow-slate-900/10 lg:grid-cols-[0.9fr_1.1fr]">
        <aside className="hidden flex-col justify-between bg-red-700 p-12 text-white lg:flex">
          ...
          <div>
            <p className="mb-5 text-sm font-semibold uppercase tracking-[0.25em] text-red-200">
              A better way to begin
            </p>
            <h2 className="text-4xl font-bold leading-tight">
              Make space for what matters.
            </h2>
            <p className="mt-5 max-w-sm leading-7 text-red-100">
              A clear, calm place to manage your account and keep moving
              forward.
            </p>
          </div>
          <p className="text-sm text-red-200">
            Simple by design. Ready when you are.
          </p>
        </aside>
